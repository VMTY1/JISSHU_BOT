...
URL = "https://git.heroku.com/nameless-savannah-93756.git".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://git.heroku.com/nameless-savannah-93756.git".format(FQDN, PORT)
